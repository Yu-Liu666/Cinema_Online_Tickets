...
public class Screen2SeatSelectPanel extends JPanel {
	 ...
	 */
	public void setScreen2SeatSelectPanelListener(Screen2SeatSelectPanelListener listener){
	 ...
	 * @throws SAXException
	 */
	public Screen2SeatSelectPanel(String filmName, String timeStr,JFrame frame) throws IOException, ParserConfigurationException, SAXException {
	...
	private void initData() throws IOException, ParserConfigurationException, SAXException {
		...
		List<Screen> screens = ScreenSeatDomParser.getScreen("screen2At" + timeStr.split(":")[0] + "_" + timeStr.split(":")[1] + ".xml");
						...
						public void mouseClicked(MouseEvent e) {
							...
							seatSelectDialog.setSeatSelectDialogListener(new SeatSelectDialogListener() {
								...
								public void onSeatSelectClicked(String ticketType) {
									typeInfoCheck(ticketType, button, row, column, seatSelectDialog);
								}
							});
						}
					});
