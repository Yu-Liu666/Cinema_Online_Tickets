...
public class Screen3SeatSelectPanel extends JPanel {
	 ...
	 */
	public void setScreen3SeatSelectPanelListener(Screen3SeatSelectPanelListener listener){
	 ...
	 * @throws SAXException
	 */
	public Screen3SeatSelectPanel(String filmName, String timeStr, JFrame frame) throws IOException, ParserConfigurationException, SAXException {
	...
	private void initData() throws IOException, ParserConfigurationException, SAXException {
		...
		List<Screen> screens = ScreenSeatDomParser.getScreen("screen3At" + timeStr.split(":")[0] + "_" + timeStr.split(":")[1] + ".xml");
